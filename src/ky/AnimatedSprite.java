...
public class AnimatedSprite extends Sprite {
	...
	public AnimatedSprite(BufferedImage[] images, Vector2D position, double animationTime, int layer) {
	...
	public AnimatedSprite(BufferedImage[] images, Vector2D position, int width, int height, double animationTime, int layer) {
		super(images, position, width, height, layer);
		this.animationTime = animationTime * (double) 1000 / images.length;
		this.animationReferenceTime = System.currentTimeMillis();
	}
	
	public AnimatedSprite(BufferedImage[] images, Vector2D position, double animationTime, int layer, String name) {
		super(images, position, layer, name);
		this.animationTime = animationTime * (double) 1000 / images.length;
		this.animationReferenceTime = System.currentTimeMillis();
	}
	
	public AnimatedSprite(BufferedImage[] images, Vector2D position, int width, int height, double animationTime, int layer, String name) {
		super(images, position, width, height, layer, name);
		this.animationTime = animationTime * (double) 1000 / images.length;
		this.animationReferenceTime = System.currentTimeMillis();
	}
	
	public AnimatedSprite(String[] filenames, Vector2D position, double animationTime, int layer) {
		super(filenames, position, layer);
		this.animationTime = animationTime * (double) 1000 / filenames.length;
		this.animationReferenceTime = System.currentTimeMillis();
	}
	
	public AnimatedSprite(String[] filenames, Vector2D position, int width, int height, double animationTime, int layer) {
		super(filenames, position, width, height, layer);
		this.animationTime = animationTime * (double) 1000 / filenames.length;
		this.animationReferenceTime = System.currentTimeMillis();
	}
	
	public AnimatedSprite(String[] filenames, Vector2D position, double animationTime, int layer, String name) {
		super(filenames, position, layer, name);
		this.animationTime = animationTime * (double) 1000 / filenames.length;
		this.animationReferenceTime = System.currentTimeMillis();
	}
	
	public AnimatedSprite(String[] filenames, Vector2D position, int width, int height, double animationTime, int layer, String name) {
